...
var  groupList = [
  {
    ...
    'logo': '/assets/css/dev-workshop.svg',
    'css': '/assets/css/dev-workshop.css',
  },
  {
    'groupId': 'fluf3ju5glad1nap3ec6',
    'name': 'Open Indy Brigade',
    'defaultChannel': 'open-indy-brigade',
    'logo': '/assets/css/open-indy-brigade.svg',
    'css': '/assets/css/open-indy-brigade.css'
  },
  {
    'groupId': 'teds6oz7cek6hoy5ghak',
    'name': 'CreativeMornings Indianapolis',
    'defaultChannel': 'cm-indy',
    'logo': '/assets/css/cm-indy.svg',
    'css': '/assets/css/cm-indy.css'
  },
  {
    'groupId': 'fraw9ap9doch6goc0ad7',
    'name': 'Ansible',
    'defaultChannel': 'playpen',
    'logo': '/assets/css/ansible.svg',
    'css': '/assets/css/ansible.css'
  },
  {
    'groupId': 'nigh4ab3an6erj3ai7hi',
    'name': 'Iowa',
    'defaultChannel': 'iowa',
    'logo': '/assets/css/iowa.svg',
    'css': '/assets/css/iowa.css'
  }
];
  ...
  app.get('/:groupId?', (req, res) => {
    ...
    let page = dom('html',
      dom('head',
        ...
        dom('link rel="shortcut icon"', { href: 'href="/assets/favicon.ico' }),
