...
var  groupList = [
	...
	{
		'groupId': 'M9AYWcyufqHLzLDTCKh1',
		'name': 'Girl Develop It',
		'defaultChannel': 'girl-develop-it',
		'logo': CSS_PATH+'girl-develop-it.svg',
		'css': CSS_PATH+'girl-develop-it.css'
	},
	{
		'groupId': 'Afa7hAoTdSoXwVpCQ11U',
		'name': 'Experience Makers',
		'defaultChannel': 'experience-makers',
		'logo': CSS_PATH+'exp-makers.svg',
		'css': CSS_PATH+'exp-makers.css'
	},
	{
	...
	{
		'groupId': 'she4ytoexq2uiapnsa0x',
		'name': 'Indy Open Hardware',
		'defaultChannel': 'indy-open-hardware',
		'logo': CSS_PATH+'indy-open-hardware.svg',
		'css': CSS_PATH+'indy-open-hardware.css'
	},
	{
		'groupId': 'c9e47jclecdmmvyd0zxg',
		'name': 'The Dive Club',
		'defaultChannel': '_dive-club',
		'logo': CSS_PATH+'dive-club.svg',
		'css': CSS_PATH+'dive-club.css'
	},
	{
	...
	app.get('/:groupId', (req, res) => {
		...
		let page = dom('html',
			dom('head',
				...
				// dom('link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Oswald:400,300,700"'),
